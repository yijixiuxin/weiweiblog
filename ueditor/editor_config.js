...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //屏幕截图配置区
        ,snapscreenHost: 'xwblog.duapp.com'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
